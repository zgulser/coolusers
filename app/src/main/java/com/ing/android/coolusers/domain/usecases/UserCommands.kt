...
class GetUser(val uid: String, queryParams: Map<out String, String> = HashMap(), val gateway: CommandGateway) : Command {
...
class CreateUser(val user: User, queryParams: Map<out String, String> = HashMap(), val gateway: CommandGateway) : Command {
...
@SuppressWarnings("showcase: not used")
class DeleteUser(val uid: String, queryParams: Map<out String, String> = HashMap(), val gateway: CommandGateway) : Command {
...
@SuppressWarnings("showcase: not used")
class UpdateUser(val user: User, queryParams: Map<out String, String> = HashMap(), val gateway: CommandGateway) : Command {
